...
public class BuyStepdefs {
  ...
  @When("I overbuy {string} with quantity {int}")
        public void i_overbuy_with_quantity(String name, int quantity ) throws NotEnoughStockException {
        Product prod = catalog.getProduct(name);
        assertThrows(NotEnoughStockException.class, () -> {prod.checkStock(quantity);});
